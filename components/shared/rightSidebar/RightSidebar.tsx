...
const RightSidebar = () => {
  ...
  const papularTag = [
    ...
    { _id: 2, name: "css", totalQuestion: 10 },
    { _id: 3, name: "Html", totalQuestion: 10 },
    { _id: 4, name: "javaScript", totalQuestion: 10 },
    { _id: 5, name: "javaScript", totalQuestion: 10 },
  ];
  return (
    <div className="background-light900_dark200  light-border custom-scrollbar sticky right-0 top-0 flex h-screen w-[350px] flex-col overflow-y-auto border-l p-6 pt-36 shadow-light-300 dark:shadow-none max-xl:hidden">
      ...
      <div className="mt-16">
        {" "}
        <h3 className="h3-bold text-dark200_light900">Papular Tags</h3>
